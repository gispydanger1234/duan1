 ...
 */
public class Lich_Su_Fragment extends Fragment {
    ...
    public static Lich_Su_Fragment newInstance(String param1, String param2) {
        Lich_Su_Fragment fragment = new Lich_Su_Fragment();
